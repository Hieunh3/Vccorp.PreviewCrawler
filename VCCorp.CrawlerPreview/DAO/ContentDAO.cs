    ...
    public class ContentDAO
    {
        ...
        public async Task<int> InserContent(ContentDTO content)
        {
            ...
            try
            {
                ...
                string query = "insert ignore into crawler_preview.content_detail (Subject,TotalPoint,ImgThumb,Summary,Contents,Domain,ReferUrl,CreateDate) " +
                    "values (@Subject,@TotalPoint,@ImgThumb,@Summary,@Contents,@Domain,@ReferUrl,@CreateDate)";
                ...
                cmd.Parameters.AddWithValue("@ImgThumb", content.ImageThumb);
